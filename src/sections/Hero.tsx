...
export const HeroSection = () => {
    return (
        <div className="py-32  md:py-48 lg:py-38 relative min-h-screen flex items-center justify-center text-white overflow-hidden">
            ...
            <motion.div className="absolute top-10 left-10 size-36 bg-yellow-400/30 rounded-full blur-xl animate-pulse" initial={{ opacity: 0, scale: 0.5 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 1 }}/>
            <motion.div className="absolute bottom-20 right-20 size-36 bg-pink-400/30 rounded-full blur-xl animate-pulse" initial={{ opacity: 0, scale: 0.5 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 1, delay: 0.5 }}/>
