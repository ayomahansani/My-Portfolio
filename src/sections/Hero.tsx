      ...
      <div className="py-32 md:py-48 lg:py-38 relative z-0 overflow-x-clip">
          <div className="absolute inset-0 [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_70%,transparent)]">
              ...
              <HeroOrbit size={520} rotation={-41} shouldOrbit orbitDuration="34s">
                  <div className="size-2 rounded-full bg-red-300/20"/>
              </HeroOrbit>
          ...
          <div className="container">
              <div className="flex flex-col items-center">
                  ...
                  <div
                      ...
                      <div className="bg-red-300 size-2.5 rounded-full relative">
                          <div className="bg-red-300 absolute inset-0 rounded-full animate-ping-large"></div>
                      </div>
