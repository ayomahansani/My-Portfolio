                ...
                <div className="mt-16 flex flex-wrap justify-center gap-8 lg:gap-12">
                    {skills.map((category, index) => (
                        <Tilt key={index} options={{ max: 18, scale: 1.08 }}>
                            <Card className="w-[340px] lg:w-[400px] p-4 lg:p-8 shadow-2xl shadow-pink-400/20 hover:scale-108 transition-transform border border-gray-700">
                                <h3 className="text-2xl lg:text-3xl font-bold text-gray-400 text-center mb-6">
                                    {category.title}
                                </h3>
                                <div className="flex flex-wrap justify-center gap-4">
                                    {category.skills.map((skill, i) => (
                                        <div
                                            key={i}
                                            className="flex items-center gap-2 px-4 py-2 lg:px-5 lg:py-3 bg-gray-900 rounded-xl shadow-lg border border-gray-700 transition hover:border-pink-400 hover:shadow-yellow-400/30"
                                        >
