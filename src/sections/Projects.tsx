        ...
        <div className="container">
          ...
          <div className="flex flex-col mt-10">
            {portfolioProjects.map(project => (
                ...
                after:outline after:outline-2 after:-outline-offset-2 after:rounded-3xl after:outline-white/20">
                  <div className="flex">
                    <div className="inline-flex gap-2 bg-gradient-to-r from-emerald-300 to-sky-400 font-bold uppercase tracking-widest text-sm">
