                ...
                <div className="container mx-auto">
                    ...
                    <div className="mt-12 flex flex-col lg:flex-row gap-10">
                        ...
                        <div className="w-full lg:w-1/3 flex flex-col gap-6 justify-center">
                            <div
                                className="p-6 bg-gray-800 rounded-lg shadow-lg shadow-pink-400/20 flex items-center gap-4 hover:scale-105 transition-all duration-300 ease-in-out">
                            ...
                            <div
                                className="p-6 bg-gray-800 rounded-lg shadow-lg shadow-yellow-300/20 flex items-center gap-4 hover:scale-105 transition-all duration-300 ease-in-out">
